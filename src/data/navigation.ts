...
export const docSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'seeding', title: 'Seeding', description: 'DatabaseSeeder, Seeder.Call(), and db:seed' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'factories', title: 'Factories', description: 'Model factories, states, sequences, and callbacks' },
