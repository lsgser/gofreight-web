...
export const docSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'controllers', title: 'Controllers', description: 'Request handling, views, and JSON responses' },
      { slug: 'middleware', title: 'Middleware', description: 'HTTP pipeline, CSRF, CORS, rate limiting' },
      { slug: 'orm', title: 'ORM', description: 'Models, queries, associations, and validations' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'cache', title: 'Cache', description: 'Memory, Redis, and HTTP caching' },
